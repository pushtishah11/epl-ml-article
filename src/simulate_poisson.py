...
plt.title("Leicester Simulated Points Distribution (2015/16)")
plt.xlabel("Points")
plt.ylabel("Frequency")
plt.legend()
plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("outputs/leicester_points_distribution.png")
plt.close()

# --- Step 5: Leicester-specific plot ---
plt.figure(figsize=(10,6))
plt.hist(results_df["Leicester"], bins=30, alpha=0.7, color="blue", edgecolor="black")
plt.axvline(81, color="red", linestyle="--", label="Actual Points (81)")
plt.title("Leicester Simulated Points Distribution (2015/16)")
plt.xlabel("Points")
plt.ylabel("Frequency")
...
plt.figure(figsize=(10,6))
plt.bar(top_titles.index, top_titles.values, color="green", alpha=0.7)
plt.title("EPL 2015/16 Title Probabilities (Poisson Simulation)")
plt.ylabel("Probability (%)")
plt.xticks(rotation=45, ha="right")
plt.grid(axis="y", alpha=0.3)
plt.tight_layout()
plt.savefig("outputs/title_probabilities.png")
plt.close()
...
plt.ylabel("Team")
plt.tight_layout()
plt.savefig("outputs/finish_position_heatmap.png")
plt.close()
